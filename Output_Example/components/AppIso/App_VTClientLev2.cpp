...
{  /* Cyclic VTClient function */
	...
	CYCLE_4B(I2);
		if (CYCLE_4B.Q0) IsoVtcCmd_CtrlAudioSignal(psEvData->u8Instance, 1, 349,  500, 0);
		if (CYCLE_4B.Q1) IsoVtcCmd_CtrlAudioSignal(psEvData->u8Instance, 1, 493, 1000, 0);
		if (CYCLE_4B.Q2) IsoVtcCmd_CtrlAudioSignal(psEvData->u8Instance, 1, 587, 500, 0);
